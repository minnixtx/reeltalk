...
| M2 — TMDB integration | 🟨 In progress — increments 1–3 done (client `1914534`; create-or-match + backfill `26756be`; worker service `effd01e`); next: search views + suggest + dropdown (increment 4, the milestone exit bar). **TMDB API key configured in `.env`** and verified live against the real API (2026-09-09). |
