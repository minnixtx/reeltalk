...
| M1 — core film domain (first working version, part 1) | 🔄 In progress — increment 6 of ~7 done: core app + Film domain (`cbf72c2`), social app + custom User + auth + setup wizard (`a41c87b`), Shelf/ShelfFilm + binary default shelves + merge/absorb (`d45a1e4`, `cac1627`), Status + watch rules (`495469a`), film pages + shelve controls + finish flow (`313c6e1`, `4faf81b`, `2c00ba7`, `ba0b94f`), **user films page (3 tabs) + minimal home feed** (`dbfc206`, `f68599e`). **Next session starts at increment 7: admin basics + landing/about + exit-bar verification.** Plan for the increments is in §2 below. |
